...
align = {};
align.horizontal = {"left":1, "right":2, "center":3};
align.vertical = {"top":1, "bottom": 2, "middle":3 };
...
HeaderLabel = function(text) {
    ...
    headerLabel.horizontalAlign = function(_alignment) {
        centrum = (width-headerLabel.textSize().width);
        if(_alignment == align.horizontal.left){
            horizontalAlign = 0;;
        }else if(_alignment == align.horizontal.right){
            horizontalAlign = centrum;
        }else if (_alignment == align.horizontal.center){
            horizontalAlign = centrum/2;
        }
        return headerLabel;
    };
    
    headerLabel.verticalAlign = function(_alignment) {
        middle = (height-headerLabel.textSize().height);
        if(_alignment == align.vertical.top){
            verticalAlign = 0;;
        }else if(_alignment == align.vertical.bottom){
            verticalAlign = middle;
        }else if (_alignment == align.vertical.middle){
