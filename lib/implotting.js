...
var HeaderManager = function(_settings, _data, _imGraph) {
    ...
    this.getMinimalSizePos = function(_headerPos) {
        ...
        return sidesHeadersSize.start + sidesHeadersSize.end + minLabelsSize + paddingStart + paddingStart*NumberOfPaddings*0.5 + paddingEnd + paddingEnd*NumberOfPaddings*0.5; 
    }.bind(this);
...
var Header = function(_headerPos, _imGraph) {
    ...
    this.layout = function(){
        ...
        //imGraph.headerManager.layoutInfo(this.combineSettings);
        ...
        var longest = totalLongestSide - extraWidth.start - extraWidth.end;
        ...
        data.labels.forEach(function(value, key, array) {
            ...
            label.text(text);
            label[x](steps*key + extraWidth.start);
            label[y](headerWidth);
